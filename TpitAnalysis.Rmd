...
Multiple ways to display these in a grid. The gridExtra package is pretty simple. See https://cran.r-project.org/web/packages/egg/vignettes/Ecosystem.html for a useful vignette.
...
Beyond the R help documentation for cor(), I like the visualizations from http://www.sthda.com/english/wiki/visualize-correlation-matrix-using-correlogram
